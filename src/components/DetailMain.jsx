            ...
            <div class="container px-5 py-24 mx-auto">
                ...
                <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                    ...
                    <span class="flex items-center">
                        ...
                        <button><svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-4 h-4 text-newBlue hover:text-newGreen" viewBox="0 0 24 24">
                        <path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"></path>
                        </svg></button>
                        <button class="ml-3 text-newBlue hover:text-newBeige">4 Reviews</button>
                    </span>
                    <span class="flex ml-3 pl-3 py-2 border-l-2 border-gray-200">
                        <button class="ml-2 text-newGreen hover:text-newBlue">
